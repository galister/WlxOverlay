...
namespace WaylandSharp
{
    ...
    public enum ZwpVirtualKeyboardV1Error : uint
    {
        NoKeymap = 0
    }

    public unsafe partial class ZwpVirtualKeyboardV1 : WlClientObject
    {
        internal ZwpVirtualKeyboardV1(_WlProxy* proxyObject) : base(proxyObject)
        {
        }

        public void Keymap(uint format, int fd, uint size)
        {
            CheckIfDisposed();
            var arg0 = format;
            var arg1 = fd;
        ...
        public void Key(uint time, uint key, uint state)
        {
            CheckIfDisposed();
            var arg0 = time;
            var arg1 = key;
        ...
        public void Modifiers(uint mods_depressed, uint mods_latched, uint mods_locked, uint group)
        {
            CheckIfDisposed();
            var arg0 = mods_depressed;
            var arg1 = mods_latched;
            var arg2 = mods_locked;
            var arg3 = group;
            WlProxyMarshalFlags(_proxyObject, 2, null, WlProxyGetVersion(_proxyObject), 0, arg0, arg1, arg2, arg3);
        }
    ...
    public enum ZwpVirtualKeyboardManagerV1Error : uint
    {
        Unauthorized = 0
    }

    public unsafe partial class ZwpVirtualKeyboardManagerV1 : WlClientObject
    {
        internal ZwpVirtualKeyboardManagerV1(_WlProxy* proxyObject) : base(proxyObject)
        {
        }

        public ZwpVirtualKeyboardV1 CreateVirtualKeyboard(WlSeat seat)
        {
            CheckIfDisposed();
            var interfacePtr = WlInterface.ZwpVirtualKeyboardV1.ToBlittable();
            var arg0 = seat._proxyObject;
            var arg1 = (_WlProxy*)null;
            var newId = WlProxyMarshalFlags(_proxyObject, 0, interfacePtr, WlProxyGetVersion(_proxyObject), 0, arg0, arg1);
            return new ZwpVirtualKeyboardV1(newId);
        }
    }
    ...
    public enum ZwlrVirtualPointerV1Error : uint
    {
        InvalidAxis = 0,
        InvalidAxisSource = 1
    }

    public unsafe partial class ZwlrVirtualPointerV1 : WlClientObject
    {
        internal ZwlrVirtualPointerV1(_WlProxy* proxyObject) : base(proxyObject)
        {
        }
        public void MotionAbsolute(uint time, uint x, uint y, uint x_extent, uint y_extent)
        {
            CheckIfDisposed();
            var arg0 = time;
            var arg1 = x;
            ...
            var arg3 = x_extent;
            var arg4 = y_extent;
            WlProxyMarshalFlags(_proxyObject, 1, null, WlProxyGetVersion(_proxyObject), 0, arg0, arg1, arg2, arg3, arg4);
        }

        public void Button(uint time, uint button, WlPointerButtonState state)
        {
            CheckIfDisposed();
            var arg0 = time;
            var arg1 = button;
        ...
        public unsafe void Axis(uint time, WlPointerAxis axis, double value)
        {
            CheckIfDisposed();
            var arg0 = time;
            var arg1 = (uint)axis;
            var d = value + (3UL << (51 - 8));
            var arg2 = *(uint*)&d;
        ...
        public void AxisSource(WlPointerAxisSource axis_source)
        {
            CheckIfDisposed();
            var arg0 = (uint)axis_source;
            WlProxyMarshalFlags(_proxyObject, 5, null, WlProxyGetVersion(_proxyObject), 0, arg0);
        }

        public void AxisStop(uint time, WlPointerAxis axis)
        {
            CheckIfDisposed();
            var arg0 = time;
            var arg1 = (uint)axis;
            WlProxyMarshalFlags(_proxyObject, 6, null, WlProxyGetVersion(_proxyObject), 0, arg0, arg1);
        }

        public void Destroy()
        {
            CheckIfDisposed();
            WlProxyMarshalFlags(_proxyObject, 8, null, WlProxyGetVersion(_proxyObject), 0);
        }
    }

    public unsafe partial class ZwlrVirtualPointerManagerV1 : WlClientObject
    {
        internal ZwlrVirtualPointerManagerV1(_WlProxy* proxyObject) : base(proxyObject)
        {
        }

        public ZwlrVirtualPointerV1 CreateVirtualPointer(WlSeat seat)
        {
            CheckIfDisposed();
            var interfacePtr = WlInterface.ZwlrVirtualPointerV1.ToBlittable();
            var arg0 = seat._proxyObject;
            var arg1 = (_WlProxy*)null;
            var newId = WlProxyMarshalFlags(_proxyObject, 0, interfacePtr, WlProxyGetVersion(_proxyObject), 0, arg0, arg1);
            return new ZwlrVirtualPointerV1(newId);
        }
        ...
        public ZwlrVirtualPointerV1 CreateVirtualPointerWithOutput(WlSeat seat, WlOutput output)
        {
            CheckIfDisposed();
            var interfacePtr = WlInterface.ZwlrVirtualPointerV1.ToBlittable();
            var arg0 = seat._proxyObject;
            var arg1 = output._proxyObject;
            var arg2 = (_WlProxy*)null;
            var newId = WlProxyMarshalFlags(_proxyObject, 2, interfacePtr, WlProxyGetVersion(_proxyObject), 0, arg0, arg1, arg2);
            return new ZwlrVirtualPointerV1(newId);
        }
    }
    ...
    public unsafe partial class WlRegistry : WlClientObject
    {
        ...
        public WlClientObject Bind(uint name, string interfaceName, uint version = 0)
        {
            ...
            return interfaceName switch
            {
                ...
                "zwp_virtual_keyboard_v1" => new ZwpVirtualKeyboardV1(proxy),
                "zwp_virtual_keyboard_manager_v1" => new ZwpVirtualKeyboardManagerV1(proxy),
                "zxdg_output_manager_v1" => new ZxdgOutputManagerV1(proxy),
                "zxdg_output_v1" => new ZxdgOutputV1(proxy),
                "zwlr_virtual_pointer_v1" => new ZwlrVirtualPointerV1(proxy),
                "zwlr_virtual_pointer_manager_v1" => new ZwlrVirtualPointerManagerV1(proxy),
...
#pragma warning disable CA5392
    internal static unsafe class Client
    {
        ...
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, uint param0, int param1, uint param2);
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, uint param0, uint param1, uint param2);
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, uint param0, uint param1, uint param2, uint param3);
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, uint param0, int param1, int param2);
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, uint param0, uint param1, uint param2, uint param3, uint param4);
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, uint param0, uint param1, int param2);
        [DllImport(LibWaylandClient, EntryPoint = "wl_proxy_marshal_flags", ExactSpelling = true)]
        public static extern _WlProxy* WlProxyMarshalFlags(_WlProxy* proxy, uint opcode, _WlInterface* @interface, uint version, uint flags, uint param0, uint param1, int param2, int param3);
    }
    ...
    public partial class WlInterface
    {
        ...
        public static readonly WlInterface ZwpVirtualKeyboardV1;
        public static readonly WlInterface ZwpVirtualKeyboardManagerV1;
        public static readonly WlInterface ZxdgOutputManagerV1;
        public static readonly WlInterface ZxdgOutputV1;
        public static readonly WlInterface ZwlrVirtualPointerV1;
        public static readonly WlInterface ZwlrVirtualPointerManagerV1;
        static WlInterface()
        {
            ...
            ZwpVirtualKeyboardV1 = new WlInterface.Builder("zwp_virtual_keyboard_v1", 1).Method("keymap", "uhu", new WlInterface?[] { null, null, null }).Method("key", "uuu", new WlInterface?[] { null, null, null }).Method("modifiers", "uuuu", new WlInterface?[] { null, null, null, null }).Method("destroy", "1", new WlInterface?[] { });
            ZwpVirtualKeyboardManagerV1 = new WlInterface.Builder("zwp_virtual_keyboard_manager_v1", 1).Method("create_virtual_keyboard", "on", new WlInterface?[] { WlSeat, ZwpVirtualKeyboardV1 });
            ...
            ZwlrVirtualPointerV1 = new WlInterface.Builder("zwlr_virtual_pointer_v1", 2).Method("motion", "uff", new WlInterface?[] { null, null, null }).Method("motion_absolute", "uuuuu", new WlInterface?[] { null, null, null, null, null }).Method("button", "uuu", new WlInterface?[] { null, null, null }).Method("axis", "uuf", new WlInterface?[] { null, null, null }).Method("frame", "", new WlInterface?[] { }).Method("axis_source", "u", new WlInterface?[] { null }).Method("axis_stop", "uu", new WlInterface?[] { null, null }).Method("axis_discrete", "uufi", new WlInterface?[] { null, null, null, null }).Method("destroy", "1", new WlInterface?[] { });
            ZwlrVirtualPointerManagerV1 = new WlInterface.Builder("zwlr_virtual_pointer_manager_v1", 2).Method("create_virtual_pointer", "on", new WlInterface?[] { WlSeat, ZwlrVirtualPointerV1 }).Method("destroy", "1", new WlInterface?[] { }).Method("create_virtual_pointer_with_output", "2oon", new WlInterface?[] { WlSeat, WlOutput, ZwlrVirtualPointerV1 });
        }
